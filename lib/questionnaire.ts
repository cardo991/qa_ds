...
export interface QAItem {
  id: string        // key único en DB
  displayId: string // lo que se muestra en el badge
  tipo: string
  aspecto: string
  validar: string
  criterio: string
